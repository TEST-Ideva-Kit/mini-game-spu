...
│   └── deploy/none/  # Platform-specific scaffold
└── scripts/bash/              # run-constitution.sh, run-specify.sh, run-plan.sh, …
DEPLOY.md                      # Deployment instructions for none
README.md                      # This file
```
...
This project is configured for **none**.
...
👉 [Open project in Ideva Kit](https://a99c-2405-9800-b861-734a-49ec-25b7-f85f-7e5d.ngrok-free.app/projects/b1ffc219-a227-4602-878b-450e70f3ebe2)
